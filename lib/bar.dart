...
import 'package:meng_project/projects.dart';
...
class _HomePageState extends State<HomePage>
  ...
  void initState() {
    ...
    _tabController = TabController(length: 3, vsync: this)
      ..addListener(() {
        // Set state to make sure that the [_MengTab] widgets get updated when changing tabs.
        setState(() {
          ...
          child: Column(
            children: [
              ...
              RotatedBox(
                ...
                child: _MengTabBar(
                  tabs: _buildTabs(context: context, theme: theme).map(
                    (widget) {
  ...
  List<Widget> _buildTabViews() {
    return const [
      Projects(title: "filter 1"),
      Projects(title: "filter 2"),
      Projects(title: "filter 3"),
    ];
  }
}

class _MengTab extends StatefulWidget {
  _MengTab({
    required ThemeData theme,
    IconData? iconData,
  ...
  @override
  _MengTabState createState() => _MengTabState();
}

class _MengTabState extends State<_MengTab>
  ...
  @override
  void didUpdateWidget(_MengTab oldWidget) {
...
class _MengTabBar extends StatelessWidget {
  const _MengTabBar({
    required this.tabs,
    this.tabController,
  });
